...
public class Scenario {
    ...
    /**
     * A flattened array representing the values of all the parameters in the
     * set
     */
    private final List<?> parameterValues = new ArrayList();
    ...
    /**
     * An array of arrays representing the parameter set (x), and the index of
     * the flattened-out "parameterValues" array (y). See documentation at the
     * top of the PairwiseInventory class for details
     *
     * @return
     */
    ...
    /**
     * The total number of Parameter Sets under analysis. In a web form, this
     * would be analogous to the number of fields we're testing (possible values
     * for User Type would be one Parameter Set, etc)
     *
     * @return
     */
    ...
    /**
     * The total number of values represented by all Parameter Sets under
     * analysis
     *
     * @return
     */
    ...
    /**
     * A flattened array representing the parameter set to which this value
     * belongs
     *
     * @return An array of int, containing the indices of the parameter sets to
    ...
    /**
     * The parameterPositions field (int[]) represents the "parameter position"
     * for each given value. See above for details
     */
    public void updateParameterPositions() {
        
        parameterPositions = new int[this.getParameterValuesCount()]; // the indexes tell us which parameter set the value belongs to
